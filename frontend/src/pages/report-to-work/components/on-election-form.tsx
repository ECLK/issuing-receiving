...
import { listStaffs, createOnElection, updateOnElection } from "../../../apis";
...
export const OnElectionForm = (props: OnElectionFormProps): ReactElement => {
                        ...
                        onSubmit={ (values, { setSubmitting }) => {
                            if (
                                ...
                                if (data) {
                                    ...
                                    updateOnElection(data.id, updateData).then(response => {
                                        //TODO Notify
                                        callAfterSubmit();
                                    ...
                                    createOnElection(data).then(response => {
                                        callAfterSubmit();
                                        //TODO: Notify
                                    }).catch((error: { [ key: string ]: string[] }) => {
                                        if (!error) {
