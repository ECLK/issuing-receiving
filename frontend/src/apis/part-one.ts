...
export const listOnElections = (): Promise<any> => {
    const config: AxiosRequestConfig = {
        url: apiEndpoints.partOne.onElectionDay,
        method: Methods.GET
    };
...
export const createOnElection = (data: ReportToWork<false>): Promise<any> => {
    const config: AxiosRequestConfig = {
        url: apiEndpoints.partOne.onElectionDay,
        method: Methods.POST,
        data: data
...
export const updateOnElection = (id: number, data: ReportToWork<false>): Promise<any> => {
    const config: AxiosRequestConfig = {
        url: `${apiEndpoints.partOne.onElectionDay}${id}/`,
        method: Methods.PUT,
        data: data
    };
...
export const deleteOnElection = (id: number): Promise<any> => {
    const config: AxiosRequestConfig = {
        url: `${apiEndpoints.partOne.onElectionDay}${id}/`,
        method: Methods.DELETE
    };
